    ...
    <div v-show="tab === 'intro'" class="intro">
      ...
      <div class="plan-wrapper">
        ...
        <div class="plan">
          ...
          <template v-else>
            <button class="primary buy-btn iap-buy-btn tr" @click="buy">{{$t('premium.buy.ipa-buy', price)}}</button>
            <button class="primary buy-btn iap-buy-btn tr" @click="restore">{{$t('premium.buy.ipa-restore', price)}}</button>
          </template>
          <ul>
